...
function MoviesCardList() {
  ...
  return (
    <section
      className={`movies-card-list ${location.pathname === '/saved-movies' ? 'movies-card-list_type_saved-movies' : ''}`}>
      ...
      {location.pathname === '/movies' ?
        <button className="movies-card-list__button button-hover"
                type="button">Ещё</button> : null}
    </section>
  )
}
