                ...
                <form className="auth__form">
                    <div className="auth__form-container">
                        ...
                        <div className="auth__field">
                            ...
                            <input className="auth__input" type="email" placeholder="E-mail"  minLength="4" 
              maxLength="40" required ></input>
                            <span className="auth__input-error"></span>
                        </div>
                        <div className="auth__field">
                            <label className="auth__label">Пароль</label>
                            <input className="auth__input" type="password"  placeholder="Пароль"  minLength="8" maxLength="30"   required></input>
                            <span className="auth__input-error"></span>
                        </div>
                    </div>

                    <div className="auth__form-container">
                        <button className="auth__button button-hover" type="submit">{props.buttonText}</button>
